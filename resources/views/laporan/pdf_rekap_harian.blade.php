...
<body>
    <div class="header">
        <h2>Rekap Harian Absensi Guru & Karyawan</h2>
        <p>Yayasan Salafiyah Kajen</p>
    </div>
    ...
    <div class="filter-info">
        ...
        <table style="border: none; font-size: 11px; margin: 5px 0;">
            ...
            <tr style="border: none;">
                ...
                <td style="border: none; padding: 2px 0;">: {{ \Carbon\Carbon::parse($filter['tanggal'])->format('d F Y') }}</td>
            </tr>
        </table>
    </div>
            ...
            @empty
                <tr>
                    <td colspan="7" class="center" style="padding: 20px; font-style: italic;">
                        Tidak ada data presensi untuk kriteria yang dipilih
                    </td>
                </tr>
            @endforelse
        </tbody>
