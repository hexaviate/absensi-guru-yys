        ...
        <div class="section-body">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Form Tambah Acara</h5>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan"
                                    rows="3" placeholder="Masukkan keterangan acara..." required>{{ old('keterangan') }}</textarea>
                                @error('keterangan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="acara_sehari" name="acara_sehari"
                                        value="1" {{ old('acara_sehari') ? 'checked' : '' }} onchange="toggleAcaraSehari()">
                        ...
                        <div class="row" id="tanggal_sehari_wrapper" style="display: none;">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_acara_sehari') is-invalid @enderror"
                                    id="tanggal_acara_sehari" name="tanggal_acara_sehari" value="{{ old('tanggal_acara_sehari') }}">
    ...
    <script>
        function toggleAcaraSehari() {
            ...
            if (checkbox.checked) {
                ...
                // Reset value tanggal mulai dan selesai
                tanggalMulai.value = '';
                ...
                // Reset value tanggal sehari
                tanggalAcaraSehari.value = '';
            }
        }
